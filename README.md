...
Open-source focused developer building practical software across accessibility, browser tools, web applications, security-aware utilities, and Telegram automation.
...
- I like products with clear value rather than unnecessary complexity
- I may be slow to respond, but I care about solid work

## Areas I Work In

- Accessibility-focused frontend tooling
- Browser extensions and client-side utilities
- Telegram bots and community automation systems
- Web platforms and small product-focused apps
- Security-aware admin and auditing tools
...
- Building useful browser and web tools with low-friction UX
- Shipping accessibility-oriented frontend utilities
- Working on Telegram automation and moderation systems
...
- Clean structure over unnecessary abstraction
- Useful products over demo-only projects
